...
func (r CredentialRepository) FindByUser(account model.UserNew) (o []model.CredentialSimpleVo, err error) {
...
func (r CredentialRepository) Find(pageIndex, pageSize int, name, order, field string, account model.UserNew) (o []model.CredentialForPage, total int64, err error) {
...
func (r CredentialRepository) Truncate() error {
	return r.DB.Exec("TRUNCATE TABLE credentials").Error
}
